...
export default function EditMedicationScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      const success = await MedicationService.updateMedication(medicationId, {
        name: name.trim(),
        dosage: dosage.trim(),
        schedule: schedule,
      ...
      if (success) {
        Alert.alert('✅', 'Medicamento actualizado correctamente');
        router.back();
      } else {
        Alert.alert('❌', 'Error al actualizar el medicamento');
      }
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.form}>
        <Text style={styles.title}>✏️ Editar Medicamento</Text>
